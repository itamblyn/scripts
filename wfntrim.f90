...
! Local variables
      ...
      integer kx,ky,kz, &
      i,irk,j,n,nkpt,nargs, ilen, ierror, mnband_trim
...
! Get file names from command-line arguments
      ...
      if (nargs .ne. 2) then
        call die('Usage: wfnbinasc name_wfn_bin name_wfn_bin_trim')
      endif
...
! Open units
      ...
      open(unit=8,file=TRUNC(outfile),form='unformatted')
      write(6,*) 'Trimming file ',TRUNC(infile),' '
...
! Output info
      ...
      do irk=1,kp%nrk
        ...
        do n=1,kp%mnband
          ...
          write(8) ((zc(i,j),i=1,nkpt),j=1,kp%nspin)   ! put an if statement to see if number is less than trim
        enddo
        SAFE_DEALLOCATE(zc)
      enddo
